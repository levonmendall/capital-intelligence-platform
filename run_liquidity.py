"""Run the point-in-time Global Liquidity engine."""
...
def _parse_as_of(value: str) -> datetime:
    ...
    try:
        ...
        raise argparse.ArgumentTypeError("as-of must be an ISO-8601 datetime") from error
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run and persist the U.S.-led Global Liquidity engine."
    )
    parser.add_argument(
        "--as-of",
        type=_parse_as_of,
    ...
    result = build_fred_global_liquidity_engine(
        clock=lambda: as_of,

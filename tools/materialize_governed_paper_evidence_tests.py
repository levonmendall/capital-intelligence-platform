...
RUNTIME_TEST = r'''from __future__ import annotations
...
PROVIDER_TEST = r'''from __future__ import annotations
...
def main() -> None:
    (ROOT / "tests/test_production_context_publication_runtime.py").write_text(
        RUNTIME_TEST,
        encoding="utf-8",
    )
    (ROOT / "tests/test_alpaca_historical_bars.py").write_text(
        PROVIDER_TEST,
        encoding="utf-8",
    )

...
- [x] Replace the active scheduled decision pipeline with a fail-closed production executor for `CanonicalCIOCycle` backed by complete-universe publications.

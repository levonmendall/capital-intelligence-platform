...
class ProviderDatasetType(str, Enum):
    ...
    DERIVATIVE_POSITIONING = "derivative_positioning"
    LEADING_INDICATORS = "leading_indicators"
    FORWARD_BUSINESS = "forward_business"
    FORWARD_TREND = "forward_trend"
    FORWARD_THEME = "forward_theme"
    FORWARD_MONETARY = "forward_monetary"
    FORWARD_CURRENCY = "forward_currency"

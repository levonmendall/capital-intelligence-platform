...
No classified liquid public-market family is categorically excluded from governed paper allocation. Code-level asset-class, instrument-type, symbol-count, or static-lane whitelists cannot define ownership eligibility. Eligibility is capability-based: an unavailable or unapproved provider, identity, evidence, valuation, liquidity, execution, custody, settlement, contract, lifecycle, or evaluation capability keeps the affected instrument evidence-only, research-only, or ineligible. It must never be treated as absent evidence for the purpose of claiming that the remaining market is the best use of capital.

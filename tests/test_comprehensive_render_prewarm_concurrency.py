...
def test_render_comprehensive_prewarm_uses_seven_bounded_workers(monkeypatch) -> None:
    ...
    assert runtime._RENDER_DAG_WORKERS == "7"
    assert values[runtime._DAG_WORKERS_ENV] == "7"
    assert runtime.os.environ[runtime._DAG_WORKERS_ENV] == "7"

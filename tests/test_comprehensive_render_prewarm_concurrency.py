...
def test_render_comprehensive_prewarm_uses_four_bounded_workers(monkeypatch) -> None:
    ...
    assert runtime._RENDER_DAG_WORKERS == "4"
    assert values[runtime._DAG_WORKERS_ENV] == "4"
    assert runtime.os.environ[runtime._DAG_WORKERS_ENV] == "4"

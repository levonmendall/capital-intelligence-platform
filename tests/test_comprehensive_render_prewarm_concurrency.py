...
def test_render_comprehensive_prewarm_uses_five_bounded_workers(monkeypatch) -> None:
    ...
    assert runtime._RENDER_DAG_WORKERS == "5"
    assert values[runtime._DAG_WORKERS_ENV] == "5"
    assert runtime.os.environ[runtime._DAG_WORKERS_ENV] == "5"

...
from tests.test_paper_execution_orchestration import AS_OF, construction, portfolio
...
def _files(tmp_path):
    ...
    return construction_path, portfolio_path


def test_cli_executes_complete_paper_batch(tmp_path, capsys) -> None:
    construction_path, portfolio_path = _files(tmp_path)
    result = main([

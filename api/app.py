...
def create_app(
    ...
    app = FastAPI(
        ...
        description=(
            ...
            "valuation, technical-momentum, risk, multi-engine normalization, "
            "and versioned weighted synthesis, investor objectives, Personal CIO "
    ...
    app.include_router(synthesis_router, dependencies=protected)

...
def create_app(
    ...
    app = FastAPI(
        ...
        description=(
            ...
            "global liquidity, business-cycle, credit-cycle, market-breadth, and "
            "valuation intelligence, investor objectives, Personal CIO briefs, "
            "decisions, replays, personal memory, conviction trends, "
